...
if __name__ == "__main__":
    ...
    test_summaries = {
        "0": {
            "summary": "A collection of beach-related media including both photos and videos.",
            "item_count": 2,
            "media_types": {"image": 1, "video": 1}
        }
    }
    ...
    if result['status'] == 'success':
        print(f"Gallery created at: {result['gallery_path']}")
        print(f"Total clusters: {result['statistics']['total_clusters']}")
